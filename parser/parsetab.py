...
_lr_productions = [
  ...
  ('JUGADA -> numero_jugada_blanco espacio MOVIMIENTO espacio','JUGADA',4,'p_jugada','parser.py',66),
  ('JUGADA -> numero_jugada_blanco espacio MOVIMIENTO espacio COMENTARIO espacio','JUGADA',6,'p_jugada','parser.py',67),
