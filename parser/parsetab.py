...
_lr_productions = [
  ...
  ('COM -> MOVIMIENTO_OPCIONAL COM','COM',2,'p_com3','parser.py',256),
  ('COM -> MOVIMIENTO_OPCIONAL','COM',1,'p_com3','parser.py',257),
  ('COM -> COMENTARIO COM','COM',2,'p_com4','parser.py',266),
  ('COM -> COMENTARIO','COM',1,'p_com4','parser.py',267),
  ('MOVIMIENTO_OPCIONAL -> token_movimiento','MOVIMIENTO_OPCIONAL',1,'p_movimiento_opcional','parser.py',275),
